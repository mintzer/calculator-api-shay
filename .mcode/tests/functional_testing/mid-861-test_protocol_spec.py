...
Generated at: 2026-02-23T19:46:27.474160+00:00
...
TEST_CASES = json.loads(r'''[
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Send non-numeric string value for 'a', expect validation error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "divide_missing_fields",
        "category": "MISSING_REQUIRED",
        "endpoint": "/divide",
        "method": "POST",
        "description": "Send empty body, expect validation error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a calculation with valid operation and operands, expect 201",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a calculation with unknown operation name, expect HTTP 400",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a division calculation with b=0, expect HTTP 400",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List all stored calculations, expect 200 with array response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
