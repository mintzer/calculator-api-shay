...
Generated at: 2026-02-23T19:28:01.270798+00:00
...
TEST_CASES = json.loads(r'''[
    {
        ...
        "expected_status": 200,
        "description": "Add two positive numbers and verify the result is 8.0",
        "setup": null,
        "cleanup": null
    },
    {
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Subtract 4 from 10 and verify the result is 6.0",
        "setup": null,
        "cleanup": null
    },
    {
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Multiply 7 by 6 and verify the result is 42.0",
        "setup": null,
        "cleanup": null
    },
    {
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Divide 20 by 4 and verify the result is 5.0",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 400,
        "description": "Divide by zero should return HTTP 400 with error message",
        "setup": null,
        "cleanup": null
    },
    {
    ...
    },
    {
        ...
        "expected_status": 201,
        "description": "Create a new addition calculation and verify it returns 201 with result 40.0",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 400,
        "description": "Send an unknown operation 'modulo', expect HTTP 400 error",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 400,
        "description": "Create a division calculation with b=0, expect HTTP 400 error",
        "setup": null,
        "cleanup": null
    },
    {
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "List all calculations, expect HTTP 200 with an array response",
        "setup": null,
        "cleanup": null
    },
    {
    ...
    },
    {
        ...
        "expected_status": 404,
        "description": "Attempt to retrieve a non-existent calculation, expect HTTP 404",
        "setup": null,
        "cleanup": null
    },
    {
    ...
    },
    {
        ...
        "expected_status": 404,
        "description": "Attempt to delete a non-existent calculation, expect HTTP 404",
        "setup": null,
        "cleanup": null
    }
]''')
