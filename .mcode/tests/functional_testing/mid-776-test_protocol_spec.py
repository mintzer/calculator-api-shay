...
Generated at: 2026-02-19T16:54:48.637246+00:00
...
TEST_CASES = json.loads(r'''[
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Send string instead of number for operand a, expect validation error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply a number by zero, expect result of zero",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt to divide with missing operand b, expect validation error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a new calculation with add operation and verify 201 response with all fields",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create calculation with unknown operation, expect 400 error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create calculation with div operation and b=0, expect 400 error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "Create a calculation, then list all calculations to verify it appears",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Create a calculation, delete it, verify 204 response",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
