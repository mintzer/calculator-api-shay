...
Generated at: 2026-02-19T16:45:30.444674+00:00
...
TEST_CASES = json.loads(r'''[
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Pass string instead of number for operand and expect validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a calculation with valid add operation and verify 201 response",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a calculation with an unknown operation and expect HTTP 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a division calculation with zero divisor and expect HTTP 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "GET",
        "description": "Request a non-existent calculation ID and expect 404",
        "request_data": {
            "path": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Delete a non-existent calculation ID and expect 404",
        "request_data": {
            "path": {
                "calculation_id": 999999
            },
